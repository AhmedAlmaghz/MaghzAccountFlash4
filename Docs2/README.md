...
Both guides mirror the same 16 sections + appendices, with 80 app screenshots in each language folder (`en/assets/`, `ar/assets/`).

كلا الدليلين يغطي نفس الأقسام الـ16 + الملحقات، مع 80 لقطة شاشة في مجلد اللغة (`en/assets/`، `ar/assets/`).
...
│   ├── CONVENTIONS.md
│   ├── README.md
│   ├── 01-introduction … 16-multicurrency, 99-appendix
