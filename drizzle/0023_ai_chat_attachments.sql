...
-- lives in the renderer's in-memory registry (expires with the renderer
-- session; there is no OPFS persistence), because chat saves rewrite every
-- message and base64 would bloat the table and every save.
