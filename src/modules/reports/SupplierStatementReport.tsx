  ...
  const buildSpec = (): ReportSpec => {
    ...
    return {
      ...
      totals: {
        ...
        values: { totalOutstanding: totals.totalOutstanding, invoiceCount: suppliers.reduce((s, c) => s + c.invoiceCount, 0) },
      },
    };
  };
      ...
      <Card>
        <div className="p-4">
          ...
          <Table
            data={suppliers}
            columns={[
              { key: 'supplier', header: t('reports.supplier'), mobile: 'title' as const },
