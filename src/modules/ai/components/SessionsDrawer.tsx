      ...
      <div className="px-3 py-2 border-b border-zinc-100 dark:border-zinc-800">
        <div className="relative">
          ...
          <input
            ...
            className="w-full pr-8 pl-2.5 py-1.5 text-xs rounded-lg border border-zinc-200 dark:border-zinc-700 bg-zinc-50 dark:bg-zinc-800/50 text-zinc-700 dark:text-zinc-300 placeholder:text-zinc-400 focus:outline-none focus:ring-1 focus:ring-primary-400"
                    ...
                    {renamingId === s.id ? (
                      <div className="flex items-center gap-1" onClick={(e) => e.stopPropagation()}>
                        <input
                          ...
                          className="flex-1 text-xs px-1.5 py-0.5 rounded border border-primary-300 dark:border-primary-600 bg-white dark:bg-zinc-800 text-zinc-800 dark:text-zinc-200 focus:outline-none focus:ring-1 focus:ring-primary-400"
                        ...
                        <button
                          ...
                          className="p-0.5 rounded text-zinc-400 hover:text-zinc-600 hover:bg-zinc-100 dark:hover:bg-zinc-800"
                  ...
                  {renamingId !== s.id && (
                    <div className="flex items-center gap-0.5 opacity-0 group-hover:opacity-100 transition-opacity">
                      <button
                        ...
                        className="p-1 rounded text-zinc-300 hover:text-zinc-600 hover:bg-zinc-100 dark:hover:bg-zinc-800 transition-colors"
                      ...
                      <button
                        ...
                        className="p-1 rounded text-zinc-300 hover:text-danger-500 hover:bg-danger-50 dark:hover:bg-danger-900/20 transition-colors"
