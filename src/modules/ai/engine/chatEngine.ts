...
// Result-card rendering lives in ./resultCards (D-phase decomposition);
// re-exported so existing importers keep working untouched.
export { summarizeResult } from './resultCards';
