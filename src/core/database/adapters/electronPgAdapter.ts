...
export interface ElectronDB extends PreloadDB {
  ...
  crm?: {
    ...
    convertLeadToCustomer(payload: { id: string; name: string; phone?: string | null; email?: string | null; customerCode?: string | null; address?: string | null; taxNumber?: string | null; creditLimit?: number; createOpportunity?: boolean }): Promise<{ success: boolean; rows?: Record<string, unknown>[]; error?: string }>;
    getOpportunities(payload?: Record<string, unknown>): Promise<{ success: boolean; rows?: Record<string, unknown>[]; error?: string }>;
    getOpportunityById(payload: { id: string }): Promise<{ success: boolean; rows?: Record<string, unknown>[]; error?: string }>;
