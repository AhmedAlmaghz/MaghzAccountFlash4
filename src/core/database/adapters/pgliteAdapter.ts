...
import inventoryValuation from '@root/drizzle/0029_inventory_valuation.sql?raw';
import fxRevaluation from '@root/drizzle/0030_fx_revaluation.sql?raw';
import vatSplitPeriods from '@root/drizzle/0031_vat_split_periods.sql?raw';
import phase5CloseAssetsPeriods from '@root/drizzle/0032_phase5_close_assets_periods.sql?raw';
import leaveProvisionAccount from '@root/drizzle/0033_leave_provision_account.sql?raw';
import treasuryBoxAccounts from '@root/drizzle/0034_treasury_box_accounts.sql?raw';
...
const MIGRATIONS: { name: string; sql: string }[] = [
  ...
  { name: '0029_inventory_valuation', sql: inventoryValuation },
  { name: '0030_fx_revaluation', sql: fxRevaluation },
  { name: '0031_vat_split_periods', sql: vatSplitPeriods },
  { name: '0032_phase5_close_assets_periods', sql: phase5CloseAssetsPeriods },
  { name: '0033_leave_provision_account', sql: leaveProvisionAccount },
  { name: '0034_treasury_box_accounts', sql: treasuryBoxAccounts },
];
...
const PRODUCT_TYPES: Array<{
  ...
  sales: string | null; cogs: string | null; inv: string | null;
    ...
    { code: 'FG', name_ar: 'منتج نهائي', name_en: 'Finished Goods', appears_in_sales: true, appears_in_purchases: false, appears_in_inventory: true, appears_in_manufacturing: true, has_stock_tracking: true, has_bom: false, sales: '41101', cogs: '51101', inv: '11301' },
...
const UNITS: Array<{ code: string; name_ar: string; name_en: string; conv: number }> = [
  ...
  { code: 'BTK', name_ar: 'باكت', name_en: 'baket', conv: 1 },
];
