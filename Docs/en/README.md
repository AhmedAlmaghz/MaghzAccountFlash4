...
> The complete official guide to **MaghzAccountPro** (v0.25.4): an integrated ERP accounting system for small and medium businesses, with an Arabic-first interface, IFRS-compliant double-entry accounting, flexible VAT, multi-currency support, and the "Maghz" AI Assistant.
...
*User Guide — MaghzAccountPro v0.25.4 · Generated from source-code review · Format: Markdown*
